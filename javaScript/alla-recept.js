...
receptRäknare.innerHTML = '-- Antal recept i ALLA RECEPT: ' + recept.length + ' st. --';
...
for (let i = 0; i < nyReceptArray.length; i++) {
	...
	receptNamn.innerHTML = nyReceptArray[i].titel + ' (' + nyReceptArray[i].kategori + ')';
